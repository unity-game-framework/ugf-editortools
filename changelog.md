...
## [3.0.1](https://github.com/unity-game-framework/ugf-editortools/releases/tag/3.0.1) - 2026-01-21  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-editortools/milestone/78?closed=1)  
    

### Fixed

- Fix dropdown id incorrect ([#316](https://github.com/unity-game-framework/ugf-editortools/issues/316))  
    - Update project to _Unity 6000.3_.
    - Fix _Dropdown_ id setup changed in _Unity 6.0_.

## [3.0.0](https://github.com/unity-game-framework/ugf-editortools/releases/tag/3.0.0) - 2026-01-21  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-editortools/milestone/76?closed=1)
